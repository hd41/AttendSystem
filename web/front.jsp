<%-- 
    Document   : front
    Created on : Jun 29, 2017, 8:25:45 AM
    Author     : hd
--%>
...
<%
    ...
    String time0=dateFormat.format(cal.getTime());
...
<%
    String resp[]=new String [7];// for the resposnses like P,H,MIS
    String diff[]=new String [7];// for the time difference
    long sum=0;
    int day=0;
    try{
                    Class.forName(jdbc);
                    ...
                    for(int i=0;i<7;i++){
                        ...
                        if(date2.after(crDate) &&date2.before(cTime)){
                            //check any entry in holiday table
                            String query1="Select * from holidays where date='"+dates[i]+"'";
                            stmt=con.createStatement();
                            rs1=stmt.executeQuery(query1);
                            Boolean status1=rs1.next();
                            
                            //check any entry corresponding to the date in span table
                            ...
                            //if dates[i] is sat or sun then insert H H
			...
			<div class="attendance">
				...
				<table style="width:100%" cellpadding="4">
                                    <caption style="font-size: 24px; text-align:center;">Attendance from 
                                        ...
                                        <input type="text" name="nVal" value="<%= currTime%> ">
                                    </caption>
					<tr>
